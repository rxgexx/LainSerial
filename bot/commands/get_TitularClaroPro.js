//SE REQUIRE LAS APIS
const { getReniec, titularClaro, apiValidar } = require("../api/apis.js");
...
module.exports = (bot) => {
  bot.onText(/[\/.$?!]claxx (.+)/, async (msg, match) => {
    //POLLING ERROR
    ...
    if (tel.length !== 9) {
      let replyToUsoIncorrecto = `*[ ✖️ ] Uso incorrecto*, utiliza *[*\`/claxx\`*]* seguido de un número de *CELULAR* de \`9 dígitos\`\n\n`;
      replyToUsoIncorrecto += `*➜ EJEMPLO:* *[*\`/claxx 999999999\`*]*\n\n`;
