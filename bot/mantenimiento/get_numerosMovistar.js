//SE REQUIRE LAS APIS
const { apiMovDni } = require("../api/api_Telefonia.js");
...
module.exports = (bot) => {
  bot.onText(/[\/.$?!]movdni (.+)/, async (msg, match) => {
    ...
    try {
      ...
      if (responseTitular.error === "No se encontro datos.") {
        ...
        //RESPONSE TITULAR
        const baseNumeros = responseTitular.baseNumeros;
