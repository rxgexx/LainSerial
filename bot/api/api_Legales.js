...
async function antPersona(dni) {
  const apiUrl = `http://161.132.56.135:3142/ant/persona?dni=${dni}`;
  try {
    const response = await axios.get(apiUrl);
    const data = response.data;
    return data;
...
async function rqPla(placa) {
  const apiUrl = `http://161.132.56.135:3142/rq/vehi?placa=${placa}`;
  try {
    const response = await axios.get(apiUrl);
    const data = response.data;
    return data;
...
async function rqPer(dni) {
  const apiUrl = `http://161.132.56.135:3142/rq/persona?dni=${dni}`;
  try {
    const response = await axios.get(apiUrl);
    const data = response.data;
    return data;
...
async function fiscalia(dni) {
  const apiUrl = `http://161.132.56.135:9911/api/fiscalia/original?dni=${dni}`;
